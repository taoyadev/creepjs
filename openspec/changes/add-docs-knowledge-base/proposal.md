...
- **Risk:** Documentation drifts from implementation.
  - *Mitigation:* Embed references to authoritative specs (PRD/API) and note owners.
- **Risk:** Overlap with existing docs.
  - *Mitigation:* Position new guides as how-to/operational docs vs strategic references.
- **Risk:** Missing context for compliance.
  - *Mitigation:* Capture privacy promises + response procedures in SECURITY.md with actionable steps.
