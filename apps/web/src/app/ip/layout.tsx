...
export const metadata: Metadata = generateMetadata({
  title: 'IP Risk Checker - Proxy, VPN, ASN & Geo Lookup',
  description:
    'Check an IP address for proxy, VPN, Tor, datacenter, ASN, geolocation, risk score, and recommended action using token-gated IP intelligence.',
  path: '/ip',
});
      ...
      <StructuredData
        data={[
          structuredData.webPage({
            ...
            description:
              'Check IP risk, ASN, geolocation, proxy, VPN, Tor, datacenter, and routing signals.',
            path: '/ip',
          }),
