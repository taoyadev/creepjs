...
const fingerprintMetaForSEO: Record<string, {
  ...
  'screen-frame': { name: 'Screen Frame Detection', description: 'Screen frame and taskbar detection revealing OS interface characteristics.', category: 'Hardware' },
  'screen-resolution': { name: 'Screen Resolution', description: 'Detailed screen resolution detection for device model inference.', category: 'Hardware' },
  'color-depth': { name: 'Color Depth', description: 'Display color depth detection for screen quality tier identification.', category: 'Hardware' },
  'hardware-concurrency': { name: 'Hardware Concurrency', description: 'CPU core count detection revealing device performance tier.', category: 'Hardware' },
  'device-memory': { name: 'Device Memory', description: 'Device RAM detection for hardware capability profiling.', category: 'Hardware' },
  'languages': { name: 'Language Preferences', description: 'Browser language preferences revealing user demographics.', category: 'System' },
  'platform': { name: 'Platform Detection', description: 'Operating system platform detection via Navigator API.', category: 'System' },
  'vendor': { name: 'Browser Vendor', description: 'Browser vendor string detection for browser identification.', category: 'Browser' },
  'plugins': { name: 'Browser Plugins', description: 'Installed browser plugins enumeration for software profiling.', category: 'Browser' },
  'touch-support': { name: 'Touch Support', description: 'Touch input capability detection for device type identification.', category: 'Hardware' },
  'pdf-viewer': { name: 'PDF Viewer Support', description: 'Native PDF viewing capability detection.', category: 'Browser' },
  'cookies-enabled': { name: 'Cookies Enabled', description: 'Cookie support detection for browser configuration.', category: 'Browser' },
  'color-gamut': { name: 'Color Gamut', description: 'Display color gamut detection for screen quality assessment.', category: 'Hardware' },
  'indexed-db': { name: 'IndexedDB Support', description: 'IndexedDB API availability detection.', category: 'Browser' },
  'local-storage': { name: 'Local Storage', description: 'LocalStorage API availability detection.', category: 'Browser' },
  'session-storage': { name: 'Session Storage', description: 'SessionStorage API availability detection.', category: 'Browser' },
  'open-database': { name: 'Open Database', description: 'WebSQL/OpenDatabase API availability detection.', category: 'Browser' },
  'date-time-locale': { name: 'Date/Time Locale', description: 'Date and time formatting preferences for locale detection.', category: 'System' },
  'architecture': { name: 'CPU Architecture', description: 'CPU architecture detection via Navigator API.', category: 'System' },
  'cpu-class': { name: 'CPU Class', description: 'Legacy CPU class detection for IE compatibility.', category: 'System' },
  'os-cpu': { name: 'OS CPU', description: 'Operating system CPU information detection.', category: 'System' },
  'vendor-flavors': { name: 'Vendor Flavors', description: 'Browser vendor-specific feature detection.', category: 'Browser' },
  'reduced-motion': { name: 'Reduced Motion', description: 'Motion sensitivity preference detection for accessibility.', category: 'Accessibility' },
  'reduced-transparency': { name: 'Reduced Transparency', description: 'Transparency preference detection for accessibility.', category: 'Accessibility' },
  'inverted-colors': { name: 'Inverted Colors', description: 'Color inversion preference detection for accessibility.', category: 'Accessibility' },
  'monochrome': { name: 'Monochrome Display', description: 'Monochrome display detection via media queries.', category: 'Hardware' },
  'forced-colors': { name: 'Forced Colors', description: 'Windows High Contrast mode detection.', category: 'Accessibility' },
  'hdr': { name: 'HDR Support', description: 'High Dynamic Range display capability detection.', category: 'Hardware' },
  'contrast': { name: 'Contrast Preference', description: 'Contrast preference detection for accessibility.', category: 'Accessibility' },
  'private-click-measurement': { name: 'Private Click Measurement', description: 'Apple PCM API support detection indicating Safari browser.', category: 'Privacy' },
