...
const fingerprint = await fetch('${API_URL}/v1/fingerprint', {
  method: 'POST',
  headers: {
    'Content-Type': 'application/json',
...
# API Configuration
API_URL = '${API_URL}/v1/fingerprint'
...
if response.status_code == 200:
    ...
    curl: `curl -X POST ${API_URL}/v1/fingerprint \\
